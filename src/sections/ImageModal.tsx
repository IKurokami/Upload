...
const ImageModal: React.FC<ImageModalProps> = ({
  ...
  if (!active) return null; // Important: prevent rendering if active is null
  ...
  return (
    <>
      ...
      <AnimatePresence>
        {active && (
          <div className="fixed inset-0 flex items-center justify-center z-50 p-0 md:p-4 h-screen w-screen">
            <div
              ref={ref}
              className="bg-white dark:bg-neutral-900 rounded-xl overflow-hidden flex flex-col w-full h-screen max-w-full max-h-full md:max-w-4xl md:max-h-[90vh]"
            >
              <motion.div
